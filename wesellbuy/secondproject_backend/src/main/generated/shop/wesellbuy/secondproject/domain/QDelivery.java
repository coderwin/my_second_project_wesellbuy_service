...
public class QDelivery extends EntityPathBase<Delivery> {
    ...
    private static final long serialVersionUID = 1481327285L;
    ...
    public final EnumPath<shop.wesellbuy.secondproject.domain.delivery.DeliveryStatus> status = createEnum("status", shop.wesellbuy.secondproject.domain.delivery.DeliveryStatus.class);
