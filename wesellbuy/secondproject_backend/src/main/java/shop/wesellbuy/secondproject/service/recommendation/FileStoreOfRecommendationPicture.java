 ...
 * updated by writer :
 * update :
 * description : 추천합니다글 업로드 파일 저장에 사용
 */
@Component
@Slf4j
public class FileStoreOfRecommendationPicture {

    @Value("${file.recommendationPicture.dir}")
    private String fileDir; // 파일 경로
    @Value("${directory.recommendationPicture.dir}")
     ...
     */
    public RecommendationPicture storeFile(MultipartFile multipartFile) throws IOException {
        ...
        return RecommendationPicture.createRecommendationPicture(originalFileName, storeFileName);
    }
