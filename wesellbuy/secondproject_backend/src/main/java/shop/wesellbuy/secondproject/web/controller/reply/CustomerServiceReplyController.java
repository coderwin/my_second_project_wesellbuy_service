...
import shop.wesellbuy.secondproject.service.reply.customerservice.CustomerServiceReplyService;
...
/**
 * CustomerServiceReply Controller
 * writer : 이호진
 * init : 2023.02.13
 * updated by writer :
 * update :
 * description : CustomerServiceReply RestController 메소드 모음
 */
@RestController
...
public class CustomerServiceReplyController {
    ...
    private final CustomerServiceReplyService customerServiceReplyService;
    ...
    public ResponseEntity<ResultV2<String>> save(@RequestBody ReplyForm form,
        ...
        log.info("form : {}", form);
        // 댓글 등록
        customerServiceReplyService.save(form, sessionForm.getNum(), boardNum);
        // code 201 보내기
    ...
    public ResponseEntity<Result<String>> update(@RequestBody ReplyUpdateForm form,
        ...
        // 댓글 수정하기
        customerServiceReplyService.update(form);
    ...
    public ResponseEntity<ResultV2<String>> delete(@PathVariable int replyNum, @PathVariable int boardNum) {
        ...
        log.info("댓글삭제 성공 -> customerservice reply Num : {}", replyNum);
        // responseEntity body 생성
     ...
     */
    @GetMapping("/replies")
    @ApiOperation(value = "고객지원 댓글 목록")
    public Result<Page<ReplyDetailForm>> selectListForAdmin(CustomerServiceReplySearchCond cond, Pageable pageable) {
        log.info("customerServiceReplySearchCond cond : {}", cond);
        // 목록 검색하기
        Page<ReplyDetailForm> pageForm = customerServiceReplyService.selectListForAdmin(cond, pageable);
        // Result 객체 생성하기
