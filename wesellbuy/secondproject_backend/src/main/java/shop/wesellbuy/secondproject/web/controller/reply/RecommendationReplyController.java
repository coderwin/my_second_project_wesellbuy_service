...
import shop.wesellbuy.secondproject.service.reply.recommendation.RecommendationReplyService;
...
/**
 * RecommendationReply Controller
 * writer : 이호진
 * init : 2023.02.13
 * updated by writer :
 * update :
 * description : RecommendationReply RestController 메소드 모음
 */
@RestController
@RequestMapping("/recommendations")
@RequiredArgsConstructor
@Slf4j
public class RecommendationReplyController {

    private final RecommendationReplyService recommendationReplyService;
    ...
    @ApiOperation(value = "추천합니다 댓글 등록")
    public ResponseEntity<ResultV2<String>> save(@RequestBody ReplyForm form,
        ...
        log.info("form : {}", form);
        // 댓글 등록
        recommendationReplyService.save(form, sessionForm.getNum(), boardNum);
        // code 201 보내기
    ...
    @ApiOperation(value = "추천합니다 댓글 수정")
    public ResponseEntity<Result<String>> update(@RequestBody ReplyUpdateForm form,
        ...
        // 댓글 수정하기
        recommendationReplyService.update(form);
    ...
    @ApiOperation(value = "추천합니다 댓글 삭제")
    public ResponseEntity<ResultV2<String>> delete(@PathVariable int replyNum, @PathVariable int boardNum) {
        ...
        log.info("댓글삭제 성공 -> recommendation reply Num : {}", replyNum);
        // responseEntity body 생성
     ...
     */
    @GetMapping("/replies")
    @ApiOperation(value = "추천합니다 댓글 목록")
    public Result<Page<ReplyDetailForm>> selectListForAdmin(RecommendationReplySearchCond cond, Pageable pageable) {
        log.info("RecommendationReplySearchCond cond : {}", cond);
        // 목록 검색하기
        Page<ReplyDetailForm> pageForm = recommendationReplyService.selectListForAdmin(cond, pageable);
        // Result 객체 생성하기
