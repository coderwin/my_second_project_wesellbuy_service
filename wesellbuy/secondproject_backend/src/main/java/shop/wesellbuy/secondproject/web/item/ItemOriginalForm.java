...
//    @NotNull(message = "필수 입력입니다.")
    ...
    // 생성자
    public ItemOriginalForm(String name, Integer stock, Integer price, String content, String type, List<ItemPicture> itemPictureList, String author, String publisher, String company) {
        this.name = name;
        this.stock = stock;
        this.price = price;
