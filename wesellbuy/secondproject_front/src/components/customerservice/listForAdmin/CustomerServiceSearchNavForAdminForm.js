 ...
 */
const CustomerServiceSearchNavForAdminForm = () => {

    /// 변수 모음
    // 외부의 변수 불러오기
    const {data, handleDataChange, handleSearchClick} = useContext(CustomerServiceListForAdminContext);
  ...
  export default CustomerServiceSearchNavForAdminForm;