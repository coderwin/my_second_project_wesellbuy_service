...
const MemberDetailForm = () => {
  ...
  //   // 서버에 이미지 요청
  //   axios.get(
  //     `${serverHost}:8080/members/images/${storedFileName}`
  //   )
  //   .then((response) => {
  //     // 요청 성공
  //     console.log("요청 성공");
        ...
        <Col sm="9">
          <Form>
            ...
            <Row className="d-flex justify-content-center">
              ...
              <Col sm={12}>
              {data.selfPictureForm ? <Image className="img-responsive profil" roundedCircle src={`${serverHost}:8080/members/images/${data.selfPictureForm.storedFileName}`} /> 
